...
class SemanticSearchService:
    ...
    async def search_by_concept(
        self, concept: str, language: Optional[str] = None, top_k: int = 5
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def find_usage_examples(
        self, api_or_function: str, top_k: int = 5
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def find_similar_code(
        self, code_snippet: str, top_k: int = 5, exclude_file: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def search_with_context(
        self, query: str, context_files: List[str], top_k: int = 5
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def search_by_error_message(
        self, error_message: str, top_k: int = 5
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def search_by_file_type(
        self, query: str, file_types: List[str], top_k: int = 5
    ) -> List[Dict[str, Any]]:
        """
