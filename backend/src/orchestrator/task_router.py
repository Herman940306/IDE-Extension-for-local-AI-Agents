...
class TaskRouter:
    ...
    def analyze_task(
        ...
        # Estimate complexity
        complexity = self._estimate_complexity(description, code_context, language)
    ...
    def _estimate_complexity(
        self, description: str, code_context: Optional[str], language: Optional[str]
    ) -> float:
    ...
    def _suggest_agent_priority(self, intent: TaskIntent, complexity: float) -> list:
