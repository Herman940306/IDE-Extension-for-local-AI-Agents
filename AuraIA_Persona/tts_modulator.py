...
PRESETS = {
    "calm": {"voice":"rachel","pace":0.9,"pitch":0.95,"breathiness":0.15,"pause_ms":200},
    "energetic": {"voice":"rachel","pace":1.15,"pitch":1.05,"breathiness":0.05,"pause_ms":120},
    "empathetic": {"voice":"rachel","pace":0.95,"pitch":0.98,"breathiness":0.25,"pause_ms":180},
    "technical": {"voice":"rachel","pace":1.0,"pitch":1.0,"breathiness":0.05,"pause_ms":100}
}

def generate_tts_params(archetype: str="calm", intensity: float=0.5) -> Dict[str, Any]:
    ...
    p["pause_ms"] = int(max(80, min(400, p["pause_ms"] * (1.0 + (0.2 * (1-intensity))))))
    return p
