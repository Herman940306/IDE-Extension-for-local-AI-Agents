...
export class StatusBarManager {
  ...
  constructor(wsClient: WebSocketClient) {
    ...
    this.statusBarItem.tooltip =
      "Enterprise AI Agents - Click for quick actions";
  ...
  private updateSuggestionStats() {
    if (!this.inlineSuggestionProvider) {
      ...
      this.suggestionStatsItem.accessibilityInformation = {
        label:
          "AI suggestion statistics unavailable. Inline suggestions not active.",
        role: "button",
      };
      return;
    }
    ...
    this.suggestionStatsItem.accessibilityInformation = {
      label: this.getSuggestionAccessibilityLabel(
        stats.generated,
        stats.accepted,
        stats.rejected,
        acceptanceRate,
