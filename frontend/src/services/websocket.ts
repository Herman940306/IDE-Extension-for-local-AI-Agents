...
const envUrlList =
  import.meta.env.VITE_BACKEND_WS_URLS?.toString() ||
  import.meta.env.VITE_BACKEND_WS_URL?.toString();
...
export class WebSocketService {
  ...
  private messageHandlers: Map<
    ServerMessageType,
    Set<(payload: ServerMessageMap[ServerMessageType]) => void>
  > = new Map();
  ...
  private advanceEndpoint() {
    ...
    console.log(
      "🌐 Switching WebSocket endpoint to:",
  ...
  off<K extends ServerMessageType>(
    messageType: K,
    handler: (payload: ServerMessageMap[K]) => void,
  ) {
