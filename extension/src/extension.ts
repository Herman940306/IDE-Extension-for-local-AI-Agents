...
export function activate(context: vscode.ExtensionContext) {
    ...
    wsClient.on('agent_response', (payload) => {
        ...
        // TODO: Handle agent response (will be implemented in later tasks)
    });
    ...
    const toggleModeCommand = vscode.commands.registerCommand(
        ...
        () => {
            // TODO: Implement mode toggle (will be implemented in later tasks)
    ...
    // Add WebSocket client to subscriptions for cleanup
    if (wsClient) {
        context.subscriptions.push({
